...
const faqs = [
  ["Is Aurora a bank?", "No. Aurora is currently designed as a financial collaboration layer that works with regulated payment and banking partners."],
      ...
      <section id="security" className="bg-white px-6 py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {["Secure login", "Privacy-first data", "Fraud monitoring"].map((item) => (
              <div
                key={item}
